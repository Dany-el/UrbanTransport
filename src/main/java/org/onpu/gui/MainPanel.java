...
public class MainPanel extends JPanel {
    ...
    private void getAverageDriverWorkingTimeButtonConfiguration() {
        getAverageDriverWorkingTimeButton.addActionListener(e -> {
            ...
            if (avgWorkingTime > 0) {
                mainText.setText("Avg Time: " + String.format("%.2f", avgWorkingTime));
            } else {
    ...
    private void getAverageLengthOfServiceButtonConfiguration() {
        getAverageLengthOfServiceButton.addActionListener(e -> {
            ...
            if (avgLengthOfService > 0) {
                mainText.setText("Avg Years: " + String.format("%.2f", avgLengthOfService));
            } else {
                JOptionPane.showMessageDialog(this, "The list with drivers is empty",
                        "Warning", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void getDriversOfSpecificRouteButtonConfiguration() {
        getDriversOfSpecificRouteButton.addActionListener(e -> {
            ...
            if (routeName != null) {
                java.util.List<Driver> listOfDrivers = urbanCompany.getDriversOfSpecificRoute(routeName);
    ...
    private void panelConfiguration() {
        ...
        this.add(mainText, stackComponents(0));
        this.add(getAverageDriverWorkingTimeButton, stackComponents(1));
        this.add(getAverageLengthOfServiceButton, stackComponents(2));
        this.add(getDriverWithGreatLengthOfServiceButton, stackComponents(3));
        this.add(getDriversOfSpecificRouteButton, stackComponents(4));
        this.add(getCountOfTransportsAtTimeButton, stackComponents(5));
        this.add(getGroupOfDriversButton, stackComponents(6));
        this.add(settingsButton, stackComponents(7));
    }
    /**
